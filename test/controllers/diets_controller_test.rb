...
class DietsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create diet" do
    assert_difference('Diet.count') do
      post diets_url, params: { diet: { kcal: @diet.kcal, objective: @diet.objective, tmb: @diet.tmb } }
    end
  ...
  test "should update diet" do
    patch diet_url(@diet), params: { diet: { kcal: @diet.kcal, objective: @diet.objective, tmb: @diet.tmb } }
